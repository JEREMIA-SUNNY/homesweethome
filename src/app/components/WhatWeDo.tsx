        ...
        <div className="container xl:max-w-6xl mx-auto px-4">
          <header className="text-center mx-auto mb-12 lg:px-20">
            <motion.div
              ...
              viewport={{ once: true }}
              className="text-4xl font-medium leading-normal mb-2  text-black"
            >
              What We Do
            </motion.div>
          ...
          <div className="flex flex-wrap flex-row -mx-4 text-center">
            ...
            >
              <div className="py-8 px-12 mb-12 bg-gray-50 border-b rounded-2xl border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
